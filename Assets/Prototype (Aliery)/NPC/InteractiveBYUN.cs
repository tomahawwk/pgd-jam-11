    ...
    public class InteractiveBYUN : Interactive
    {
        ...
        public Item GetItem()
        {
            ...
            foreach (var item in array)
            {
                if (item != null)
                {
                    if (_inventorySystem.HasItem(item) && !_saveStateSystem.GetState("HasItem: " + item.Title))
                    {
        ...
        public override void Interact()
        {
            ...
            {
                SayBun(
                    "С добрым утречком, хозяйка зверей, покровительница людей! Как спалось? Кости на погоду не ломило?");
                AgaSay("Уж не ты ли, пройдоха, свою лапу тут приложил, да избушку околдовал?");
                SayBun(
                    "Не я, хозяйка, не я. Но может и следовало — давно ты меня <color=yellow>рыбкой</color> не потчевала, на печи давно полежать не пускала…");
                AgaSay("А чьих это рук дело, стало быть?");
                SayBun(
                    "А они все рядом тут — ты оглядись по всем четырем сторонам, да под ноги поглядывай. Думается мне, из избушки не только ты выпала, но и всяческое барахло.");
        ...
        private void DialogeForItem(Item item)
        {
            ...
            {
                SayBun(
                    "А как же ты дотянешься, хозяйка, что-то я ни ступы, ни метлы не вижу. Ужель по лесенке карабкаться будешь?");
            }
            ...
            {
                SayBun(
                    "Этот водун такой унылый — всучить бы ему что-нибудь, чтобы хоть со стороны на веселье посмотрел. Где ж, хозяйка, твоё яблочко наливное на блюдечеке серебряном?");
            }
            else if (item == _stair)
            {
            ...
            {
                SayBun(
                    "Давненько мы, бабка, ничем не лакомились. Ни молодца доброго, ни красной девицы, ни детишек румяных… Хоть бы рыбкой какой поживиться.");
                ...
                SayBun("Отдашь рыбку?",
                    "Держи", "Не отдам", result =>
                    {
                        if (result)
                        {
                            ...
                            SayBun(
                                "Золотая рыбка? Ах, невелико угощеньице, но я готов его принять со всем великодушием. Может, я теперь сам смогу желания исполнять?");
                            SayBun(
                                "Ты глянь-ка, могу! Снял я с твоей каморки часть чар. Эх, бабка, хила и немощна ты стала, со всем тебе помогать приходится.");
                        }
                        else
                        {
            ...
            {
                SayBun(
                    "Смотать нити? Наверняка у нашей прядуньи Кикиморы найдётся, чем, только тебе просто так не даст, ты её, хозяйка, обидела.");
            }
            else if (item == _viteyka)
            {
                SayBun(
                    "Вот сколько я на своём веку повидал, одного понять не могу: это как же при сматывании на витейку получается клубочек?");
            }
